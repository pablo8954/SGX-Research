...
#endif
#ifndef OCALL_NOTHING_DEFINED__
#define OCALL_NOTHING_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_nothing, (void));
#endif
#ifndef OCALL_GETTIME_DEFINED__
#define OCALL_GETTIME_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_gettime, (long int time_array[2]));
#endif
...
sgx_status_t ecall_test_mprotect(sgx_enclave_id_t eid);
